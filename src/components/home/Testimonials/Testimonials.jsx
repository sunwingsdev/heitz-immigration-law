      ...
      <div className="relative -z-10">
        ...
        <div className="absolute inset-0 flex items-center justify-center max-w-4xl mx-auto">
          <div className="text-center text-white">
            <h2 className="text-[42px] leading-[45px] font-bold mb-4">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <BookButton text={"CALL 561-290-252"} />
            </div>
          </div>
        </div>
      </div>
      <div className="absolute bottom-0 left-0 right-0 z-20 flex justify-center items-center bg-[#f6f2f2] -mb-[200px] max-w-[67rem] mx-auto">
